...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  const managerFetch = async ( email, password) => {
    setIsLoading(true);
    console.log("MANAGER");
    const response = await fetch(
      "http://localhost:4000/api/auth/signin/manager",
      {
        method: "POST",
        headers: {
...
console.log(json);
  ...
  const managerSignup = (e) => {
    e.preventDefault();
    managerFetch(email, password);
  };
//   ----------------------------------------------------------------------------------------------------------------------------------
const employeeFetch = async ( email, password) => {
    setIsLoading(true);
                  ...
                  {isAdmin==='MANAGER'? <button
                    ...
                    >
                      <div className="flex flex-row items-center justify-center">
                        ...
                        <div className="font-bold">Signin {isAdmin}</div>
                      </div>
                    </button>
          :
                    <button
